...
context.load_cert_chain(certfile="./serverCert/rootCA.pem",keyfile="./serverCert/rootCA.key")
...
def multi_threaded_client(client):
    ...
    # print("Started Serving the Client")
    register=True
    ...
    if text==False:
        ...
        print("Started serving the Client "+client_name)
